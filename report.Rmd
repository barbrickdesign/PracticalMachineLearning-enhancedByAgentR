...
## Introduction
The project for this course is to use machine learning to predict the manner in which a group did exercise. The following objectives are to be met as part of this report:
...
* Performed much faster than building and combining with the other algorithms
